...
const PRIVACY = [
  ...
  'Проект хранит игровой профиль, историю поставленных пикселей, их координаты, цвета и время установки, статистику, сведения о полученных наградах, рейтинге игроков и так далее.',
  ...
  'Игровые данные хранятся в базе данных и Redis проекта.',
